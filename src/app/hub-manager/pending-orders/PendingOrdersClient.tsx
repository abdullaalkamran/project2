...
import { Phone, RefreshCw, XCircle, Clock, User, AlertTriangle, Package } from "lucide-react";
...
export default function PendingOrdersClient({ onCountChange }: { onCountChange?: (n: number) => void }) {
